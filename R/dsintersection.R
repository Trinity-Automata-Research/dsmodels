...
#' @param bg A string color of string colors representing the color of the point's (or points') background. This typically manifests itself as the color of the outline of the point.
